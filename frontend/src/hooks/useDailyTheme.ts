...
const themes: DailyTheme[] = [
    {
        ...
        story: heroJugSet,
        storyAlt: 'Handcrafted ceramic tea set with gold rim accents',
    ...
    {
        hero: heroJugSet,
        heroAlt: 'Handcrafted ceramic tea set with gold rim accents',
    ...
    },
    {
        ...
        detail: heroJugSet,
        detailAlt: 'Handcrafted ceramic tea set with gold rim accents',
